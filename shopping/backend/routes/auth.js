                ...
                if (result) {
                    async function main() {
                       ...
                       let info = await transporter.sendMail({
                        ...
                        subject: "E-Commerce-Shein ✔", // Subject line
                        text: "Hello world?", // plain text body
                        html: "<b>Thank you for registering in our website.Enjoy Shopping!!! </b>", // html body
                      });
...
router.get('/orderedProducts/:id' , (req,res)=>{
    let user_id = req.params.id;
    Products.find({user_id:user_id} , (err ,result)=>{
        if(err){
            console.log(err);
        }else{
            res.send(result)
